from random import choice as choiceInSet
...
def cherchePossibilite(ens, oldEns, sizemap):
    ...
    parmis <ens>"""
    res = set()
    for case in ens - oldEns: #ensLibre:
